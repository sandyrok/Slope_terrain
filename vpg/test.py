...
l = [[20],[40],[60],[20,20],[40,40],[60,60]]
logger_kwargz = dict(output_dir='path/to/output_dir', exp_name='experiment_name')	
for x in l:
 vpg.vpg(env_fn,actor_critic=core.mlp_actor_critic,ac_kwargs=dict(hidden_sizes=x),gamma=0.99,seed=0,steps_per_epoch=5000,epochs=50,logger_kwargs=logger_kwargz)
