...
for x in l:
 ddpg.ddpg(env_fn,actor_critic=core.mlp_actor_critic,ac_kwargs=dict(hidden_sizes=x),gamma=0.99,seed=0,steps_per_epoch=5000,epochs=50,logger_kwargs=logger_kwargz)
